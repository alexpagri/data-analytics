...
class ExponNormDistribution(FixDistribution):
...
class Burr12Distribution(FixDistribution):
    ...
    def _sampleValue(self):
        return scipy.stats.burr12(self._params[0], self._params[1], self._params[2], self._params[3]).rvs()


class PowerNormDistribution(FixDistribution):
    def __init__(self, loc, scale, lamb):
        FixDistribution.__init__(self, (loc, scale, lamb))
